...
private:
  ...
  rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr odom_pose_pub_;
  rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr odom_pose_all_pub_;
  ...
  geometry_msgs::msg::Pose last_estimated_pose_;  
